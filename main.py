...
API_ID = int(os.environ.get("API_ID", 29141829))
API_HASH = os.environ.get("API_HASH", "25020d00fbcfd406fc9979d24d761bff")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7579978646:AAGrpQ4o925SCjCg6BJ3f-UYbaTe2TFcWUY")
